...
export class ProductListComponent implements OnInit {
  ...
  handleSearchProducts() {
    ...
    // if we have different keyword than previous then set thePageNumbe to 1
  ...
  handleListProducts() {
    ...
    console.log(
      `currentCategoryId = ${this.currentCategoryId}, thePageNumber=${this.thePageNumber} thePreviousCategoryId=${this.previousCategoryId}`,
    );
